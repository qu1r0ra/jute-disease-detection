...
import random
from jute_disease.utils.constants import ML_ASSETS_DIR
...
class EDA:
    ...
    def get_class_distribution(data_path):
        ...
        for class_dir in data_path.iterdir():
            if class_dir.is_dir():
                count = len(list(class_dir.glob("*.jpg"))) + len(
    ...
    def get_image_size_description(data_path):
        ...
        if df_sizes.empty:
            ...
            save_path = ML_ASSETS_DIR / "image_size_distribution.png"
    ...
    def preview_class_samples(data_path, num_samples=5):
        ...
        fig, axes = plt.subplots(
            len(classes), num_samples, figsize=(num_samples * 3, len(classes) * 3)
        )
